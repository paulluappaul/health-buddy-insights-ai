...
import { Heart, BarChart3, Utensils, Shield, Settings, Brain } from 'lucide-react';

const MainTabNavigation = () => {
  return (
    <div className="w-full flex justify-center mb-8 px-2">
      <TabsList className="grid w-full max-w-3xl grid-cols-6 h-14 bg-white/80 backdrop-blur-sm border border-slate-200/60 shadow-lg shadow-slate-900/5 rounded-2xl p-1">
        <TabsTrigger 
          value="track" 
        ...
        <TabsTrigger 
          value="ai-analysis" 
          className="flex items-center gap-2 rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-500 data-[state=active]:to-blue-500 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-200 hover:scale-105"
        >
